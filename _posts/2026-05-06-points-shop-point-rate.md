...
<figure>
  <img src="/images/blog/points-shop-point-rate/screen.webp"
       alt="ショップポイント交換の設定カード。有効にするトグル、交換レートがIllumenza特典100ptからショップポイント5ptへ、交換制限のトグルはオフ、その下にVIPランク別レートのトグル。">
  <figcaption>交換レートは「特典ポイント → ショップポイント」の2つの数値で決まります。</figcaption>
</figure>

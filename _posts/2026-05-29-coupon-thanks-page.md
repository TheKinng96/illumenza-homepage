...
フォームの入力は、参加をやめる理由になります。メールアドレスを打つのが面倒で閉じられることも、よくある離脱です。
...
入力欄がないので、入力途中での離脱も起きません。フォーム離脱がゼロになる、と言えます。
...
通常のフォーム用とは別に設定するので、両方を埋めておく必要があります。
...
メールアドレスはもともと注文時に取得しています。参加者一覧には記録されますが、リストが新しく増えるわけではありません。

...
<figure>
  <img src="/images/blog/points-panel-items/settings.webp"
       alt="表示パネルの会員タブ設定画面。表示項目としてチケット数の切り替えと見出しテキストがあり、その下の表示順の設定に、チケット・紹介・会員クラス・チケット獲得利用履歴・マイクーポン・アカウントの6項目がドラッグして並べ替えられる形で並んでいる。"
       loading="lazy" decoding="async">
  <figcaption>6つのセクションをドラッグで並べ替えられます。</figcaption>
</figure>

- **チケット** — 残高と、貯め方・使い方への入口
- **紹介** — 友達紹介のリンクと共有ボタン
- **会員クラス** — 現在のクラスと次のクラスまでの距離
- **チケット獲得・利用履歴** — その会員自身の増減
...
**導入直後**は、チケットを一番上に置くのが素直です。まだ残高がゼロの会員が多く、「どうすれば貯まるか」への入口が要ります。
...
会員クラスは、クラスの数が3つ以上あって、特典に差がついてから上げてください。クラスが2つしかない状態で目立たせても、見るものがありません。

## 「チケット数を表示する」の切り替え

表示項目には、チケット数そのものを出すかどうかの設定があります。
...
6つのセクションは、いま会員にしてほしいことの順に並べてください。導入直後はチケット、交換先が増えたらマイクーポンです。

...
当選したあと、そのクーポンの有効期限までをカウントダウンする帯です。
...
目安は、**そのショップで購入を決めるまでにかかる時間**です。商品数が少なく単価も低いショップなら、15〜30分で足ります。比較検討が必要な商材なら、60分でも短いかもしれません。
...
- **リストを集めたい** → スピン前のオファーバーが効きます。参加してもらうのが目的なので
...
実際のショップで開いて、**帯が重なっていないか**を確認してください。設定画面のプレビューは帯単体の表示で、他の要素との重なりまでは再現しません。

...
他の交換先と違い、限定特典は**こちらの都合で断れます。** 在庫がなくなった、日程が合わなかった、条件を満たしていなかった。そうした場合に却下すれば、メンバーのマイルは戻ります。
...
期間限定の特典は、終了後に無効化しておいてください。有効なまま残っていると、終わった特典に申請が来ます。却下すればマイルは戻りますが、メンバーには無駄な期待をさせることになります。

## まとめ

限定特典は、マイルを凍結してから人が対応する仕組みです。却下でマイルが返るためメンバー側のリスクは低く、そのぶん申請は増えます。

...
description: "限定特典はクーポンを発行しません。チケットを凍結してから店舗が直接やりとりする仕組みと、却下でチケットが返る挙動、そして受け渡しがアプリ外になる点を説明します。"
...
チケットの交換先には、クーポンでも商品でもない枠があります。**限定特典**です。
...
**2. 凍結** — この時点でチケットが凍結されます。まだ消費はされていませんが、他の交換には使えません。同時にショップオーナーへメール通知が届きます。

**3. 連絡** — オーナーがメンバーと直接やりとりします。連絡先は、メンバーが申請時に共有したもの（LINE IDなど）を使います。

**4. 承認** — 承認待ちページで承認すると、チケットが消費されて完了します。**却下した場合、チケットは返還されます。**

## 却下でチケットが返るのが重要です

他の交換先と違い、限定特典は**こちらの都合で断れます。** 在庫がなくなった、日程が合わなかった、条件を満たしていなかった。そうした場合に却下すれば、メンバーのチケットは戻ります。
...
期間限定の特典は、終了後に無効化しておいてください。有効なまま残っていると、終わった特典に申請が来ます。却下すればチケットは戻りますが、メンバーには無駄な期待をさせることになります。

## まとめ

限定特典は、チケットを凍結してから人が対応する仕組みです。却下でチケットが返るためメンバー側のリスクは低く、そのぶん申請は増えます。
